...
public class ViewSongMessageConsumer(
    IRepository<TopSong> topRepository,
    IRepository<Song> songRepository,
    IRepository<SongView> viewRepository,
    ILogger<ViewSongMessageConsumer> logger) : IConsumer<ViewSongMessage> {
